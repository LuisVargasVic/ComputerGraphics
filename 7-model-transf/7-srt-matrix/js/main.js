...
{	
	...
	modelMatrix = mat4.create(); // Model = I
	modelMatrix = mat4.scale(modelMatrix, modelMatrix, [tx, ty, 1.]);

	// Rotation
	var tetha = 45. * Math.PI / 180.;
	mat4.rotate(modelMatrix, modelMatrix, tetha, [0., 0., 1.]);

	// Translation
	var ttx = 0.5;
	var tty = -0.5;
	modelMatrix = mat4.translate(modelMatrix, modelMatrix, [ttx, tty, 1.]);
